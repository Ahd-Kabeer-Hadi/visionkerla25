...
const problems = [
  {
    ...
    description:
      "Inefficient layers causing delays and communication breakdowns.",
  },
  {
    icon: MapPin,
    title: "Limited Reach",
...
export function Problem() {
  ...
  return (
    <section
      id="problem"
      className="max-w-7xl mx-auto py-10 md:py-20  bg-gray-50/50"
    >
      <div className="w-full py-4">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 leading-tight mb-4">
            Roadblocks in Kerala&apos;s Distribution System
          </h2>
          <p className="text-lg md:text-xl text-balance text-gray-600 leading-relaxed max-w-2xl mx-auto">
            Identifying key obstacles that hinder supply chain efficiency and
            limit growth.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          {problems.map((problem, index) => (
            <motion.div
              ...
              className=" p-6 rounded-2xl shadow-md hover:shadow-lg transition-shadow border border-gray-200 hover:border-gray-300"
            >
              {/* Icon */}
